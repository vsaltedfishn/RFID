...
//GND对灵敏度环境取样影响极大 ： 减小EMC电感
//磁导率2000铁氧体贴片：EMC滤波电容不变，匹配电路接地C2拉高
//
...
117
59
83？ 119 mmaybe  100好一点不大行  90不够

112     66    110最小号卡检测不到
170     66     110废物*2
130     66      110  大卡长
130     66      77   小卡读不到 不行
130     66      89 92   放在面包板上下压可以读中卡

130    60    89 87


15 117     66    110   中标签读不了
...
42/在PCB板子上   44在硅胶垫上        5          105


47pf里面拿的38/39pf  可以平替42/44pf
56pf里面拿的42/44pf
18pf里面拿的5pf
130pf里面拿的110 ；110特别少

////////////////////////////////////////////////////总结  一个42/44 从56里面拿       一个38/39从47pf里面拿       （比两个42好得多）
